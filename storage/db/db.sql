...
(
    ...
    `updated_at`               INT(11) UNSIGNED    NULL DEFAULT NULL,
    `deleted_at`               INT(11) UNSIGNED    NULL DEFAULT NULL,
    PRIMARY KEY (`id`, `catalog_storage_place_id`, `fin_transaction_type_id`, `counterparty_id`),
    UNIQUE INDEX `id_UNIQUE` (`id` ASC),
...
(
    ...
    PRIMARY KEY (`id`),
    UNIQUE INDEX `id_UNIQUE` (`id` ASC),
    UNIQUE INDEX `alias_UNIQUE` (`key` ASC),
    UNIQUE INDEX `title_UNIQUE` (`title` ASC)
)
    ENGINE = InnoDB;
...
(
    ...
    `updated_at`                 INT(11) UNSIGNED    NULL DEFAULT NULL,
    `deleted_at`                 INT(11) UNSIGNED    NULL DEFAULT NULL,
    PRIMARY KEY (`id`, `uuid`, `catalog_payment_type_id`, `catalog_delivery_type_id`, `counterparty_id`,
                 `catalog_storage_place_id`, `fin_transaction_type_id`),
    UNIQUE INDEX `id_UNIQUE` (`id` ASC),
...
(
    ...
    `document_order_id`  BIGINT(20) UNSIGNED NULL,
...
(
    ...
    `updated_at`         INT(11) UNSIGNED    NULL DEFAULT NULL,
    `deleted_at`         INT(11) UNSIGNED    NULL DEFAULT NULL,
    PRIMARY KEY (`id`, `document_id`, `catalog_product_id`),
    UNIQUE INDEX `id_UNIQUE` (`id` ASC),
...
(
    ...
    `updated_at`         INT(11) UNSIGNED    NULL DEFAULT NULL,
    `deleted_at`         INT(11) UNSIGNED    NULL DEFAULT NULL,
    PRIMARY KEY (`id`, `catalog_product_id`, `document_id`),
    UNIQUE INDEX `id_UNIQUE` (`id` ASC),
    INDEX `fk_ax_document_content_ax_catalog_product1_idx` (`catalog_product_id` ASC),
    INDEX `fk_ax_catalog_document_content_ax_catalog_storage1_idx` (`catalog_storage_id` ASC),
...
(
    ...
    `updated_at`                      INT(11) UNSIGNED    NULL DEFAULT NULL,
    `deleted_at`                      INT(11) UNSIGNED    NULL DEFAULT NULL,
    PRIMARY KEY (`id`, `catalog_storage_place_id`, `catalog_storage_place_id_target`, `fin_transaction_type_id`,
                 `counterparty_id`),
    UNIQUE INDEX `id_UNIQUE` (`id` ASC),
    INDEX `fk_ax_catalog_document_ax_currency1_idx` (`currency_id` ASC),
    INDEX `fk_ax_catalog_document_ax_catalog_storage_place1_idx` (`catalog_storage_place_id` ASC),
