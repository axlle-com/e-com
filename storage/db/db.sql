...
(
    ...
    `render_id`           BIGINT(20) UNSIGNED  NULL,
    `category_id`         BIGINT(20) UNSIGNED  NULL,
    `gallery_id`          BIGINT(20) UNSIGNED  NULL DEFAULT 0,
    `is_published`        TINYINT(1) UNSIGNED  NULL DEFAULT 1,
    `is_favourites`       TINYINT(1) UNSIGNED  NULL DEFAULT 0,
...
(
    `id`               BIGINT(20) UNSIGNED NOT NULL AUTO_INCREMENT,
    `render_id`        BIGINT(20) UNSIGNED NULL,
    `gallery_id`       BIGINT(20)          NULL DEFAULT 0,
    `is_published`     TINYINT(1) UNSIGNED NULL DEFAULT 1,
    `is_favourites`    TINYINT(1) UNSIGNED NULL DEFAULT 0,
    `is_watermark`     TINYINT(1)          NULL DEFAULT 1,
    `show_image`       TINYINT(1)          NULL DEFAULT 1,
...
-- -----------------------------------------------------
-- Table `a_shop`.`ax_infoblock_has_resource`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `a_shop`.`ax_infoblock_has_resource`;

CREATE TABLE IF NOT EXISTS `a_shop`.`ax_infoblock_has_resource`
(
