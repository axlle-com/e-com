...
(
    ...
    INDEX `fk_ax_post_category_ax_render1_idx` (`render_id` ASC) VISIBLE,
    UNIQUE INDEX `url_UNIQUE` (`url` ASC) VISIBLE,
    INDEX `fk_ax_post_category_ax_post_category1_idx` (`category_id` ASC) VISIBLE,
...
(
    ...
    UNIQUE INDEX `id_UNIQUE` (`id` ASC) VISIBLE,
    UNIQUE INDEX `alias_UNIQUE` (`alias` ASC) VISIBLE,
    INDEX `fk_ax_post_ax_render1_idx` (`render_id` ASC) VISIBLE,
    INDEX `fk_ax_post_ax_post_category1_idx` (`category_id` ASC) VISIBLE,
    UNIQUE INDEX `url_UNIQUE` (`url` ASC) VISIBLE,
...
(
    ...
    UNIQUE INDEX `id_UNIQUE` (`id` ASC) VISIBLE,
    INDEX `fk_ax_post_comments_ax_post_comments1_idx` (`comments_id` ASC) VISIBLE,
...
(
    ...
    INDEX `fk_ax_widgets_ax_render1_idx` (`render_id` ASC) VISIBLE,
...
(
    ...
    UNIQUE INDEX `id_UNIQUE` (`id` ASC) VISIBLE,
    UNIQUE INDEX `href_UNIQUE` (`image` ASC) VISIBLE,
    INDEX `fk_ax_gallery_image_ax_gallery1_idx` (`gallery_id` ASC) VISIBLE,
...
(
    ...
    INDEX `fk_ax_post_has_ax_post_tags_ax_post_tags1_idx` (`tags_id` ASC) VISIBLE,
...
(
    ...
    UNIQUE INDEX `id_UNIQUE` (`id` ASC) VISIBLE,
    INDEX `fk_ax_menu_item_ax_menu1_idx` (`menu_id` ASC) VISIBLE,
    INDEX `fk_ax_menu_item_ax_menu_item1_idx` (`menu_item_id` ASC) VISIBLE,
...
-- -----------------------------------------------------
-- Table `a_shop`.`ax_main_events`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `a_shop`.`ax_main_events`;

CREATE TABLE IF NOT EXISTS `a_shop`.`ax_main_events`
(
    `id`          BIGINT(20) UNSIGNED NOT NULL AUTO_INCREMENT,
    ...
    `updated_at`  INT(11) UNSIGNED    NULL     DEFAULT NULL,
    `deleted_at`  INT(11) UNSIGNED    NULL     DEFAULT NULL,
    INDEX `fk_ax_ips_has_ax_visitors_ax_ips1_idx` (`ips_id` ASC) VISIBLE,
    UNIQUE INDEX `id_UNIQUE` (`id` ASC) VISIBLE,
    PRIMARY KEY (`id`),
    INDEX `fk_ax_main_ips_has_resource_ax_user1_idx` (`user_id` ASC) VISIBLE,
...
(
    ...
    INDEX `fk_ax_post_has_ax_widgets_ax_widgets1_idx` (`widgets_id` ASC) VISIBLE,
...
(
    ...
    INDEX `fk_ax_menu_has_ax_post_category_ax_menu1_idx` (`menu_id` ASC) VISIBLE,
...
(
    ...
    UNIQUE INDEX `id_UNIQUE` (`id` ASC) VISIBLE,
    INDEX `fk_table1_ax_user1_idx` (`user_id` ASC) VISIBLE,
    UNIQUE INDEX `value_UNIQUE` (`token` ASC) VISIBLE,
...
(
    ...
    INDEX `fk_ax_gallery_has_resource_ax_gallery1_idx` (`gallery_id` ASC) VISIBLE,
...
(
    ...
    INDEX `fk_ax_phone_has_resource_ax_phone1_idx` (`phone_id` ASC) VISIBLE,
...
(
    ...
    PRIMARY KEY (`id`),
    UNIQUE INDEX `id_UNIQUE` (`id` ASC) VISIBLE,
    INDEX `fk_ax_catalog_category_ax_catalog_category1_idx` (`category_id` ASC) VISIBLE,
    UNIQUE INDEX `url_UNIQUE` (`url` ASC) VISIBLE,
    UNIQUE INDEX `alias_UNIQUE` (`alias` ASC) VISIBLE,
    INDEX `fk_ax_catalog_category_ax_render1_idx` (`render_id` ASC) VISIBLE,
...
(
    ...
    PRIMARY KEY (`id`),
    UNIQUE INDEX `id_UNIQUE` (`id` ASC) VISIBLE,
    INDEX `fk_ax_catalog_product_ax_render1_idx` (`render_id` ASC) VISIBLE,
    INDEX `fk_ax_catalog_product_ax_catalog_category1_idx` (`category_id` ASC) VISIBLE,
...
(
    ...
    INDEX `fk_ax_catalog_property_ax_catalog_property_type1_idx` (`catalog_property_type_id` ASC) VISIBLE,
...
(
    ...
    UNIQUE INDEX `id_UNIQUE` (`id` ASC) VISIBLE,
    UNIQUE INDEX `num_code_UNIQUE` (`num_code` ASC) VISIBLE,
    UNIQUE INDEX `char_code_UNIQUE` (`char_code` ASC) VISIBLE,
    UNIQUE INDEX `global_id_UNIQUE` (`global_id` ASC) VISIBLE
)
    ENGINE = InnoDB;
...
(
    ...
    PRIMARY KEY (`id`),
    UNIQUE INDEX `id_UNIQUE` (`id` ASC) VISIBLE,
    INDEX `fk_ax_catalog_storage_place_ax_catalog_storage_place1_idx` (`catalog_storage_place_id` ASC) VISIBLE,
...
-- -----------------------------------------------------
-- Table `a_shop`.`ax_document_sale`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `a_shop`.`ax_document_sale`;
...
(
    ...
    `resource`                 VARCHAR(255)        NOT NULL COMMENT 'Таблица контрагента',
    `resource_id`              BIGINT(20) UNSIGNED NOT NULL COMMENT 'Ид контрагента',
    `status`                   TINYINT(1) UNSIGNED NULL DEFAULT 0,
    `created_at`               INT(11) UNSIGNED    NULL DEFAULT NULL,
    `updated_at`               INT(11) UNSIGNED    NULL DEFAULT NULL,
    `deleted_at`               INT(11) UNSIGNED    NULL DEFAULT NULL,
    PRIMARY KEY (`id`, `catalog_storage_place_id`, `fin_transaction_type_id`),
    UNIQUE INDEX `id_UNIQUE` (`id` ASC) VISIBLE,
    INDEX `fk_ax_catalog_document_ax_currency1_idx` (`currency_id` ASC) VISIBLE,
    INDEX `fk_ax_catalog_document_ax_catalog_storage_place1_idx` (`catalog_storage_place_id` ASC) VISIBLE,
    INDEX `fk_ax_document_sale_ax_fin_transaction_type1_idx` (`fin_transaction_type_id` ASC) VISIBLE,
    ...
    CONSTRAINT `fk_ax_catalog_document_ax_catalog_storage_place10`
        FOREIGN KEY (`catalog_storage_place_id`)
            ...
            ON DELETE CASCADE
            ON UPDATE CASCADE,
    CONSTRAINT `fk_ax_document_sale_ax_fin_transaction_type1`
...
-- -----------------------------------------------------
-- Table `a_shop`.`ax_document_reservation`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `a_shop`.`ax_document_reservation`;
...
(
    ...
    CONSTRAINT `fk_ax_catalog_document_ax_catalog_storage_place1000`
        FOREIGN KEY (`catalog_storage_place_id`)
            ...
            ON DELETE CASCADE
            ON UPDATE CASCADE,
    CONSTRAINT `fk_ax_document_sale_ax_fin_transaction_type100`
        FOREIGN KEY (`fin_transaction_type_id`)
            REFERENCES `a_shop`.`ax_fin_transaction_type` (`id`)
            ON DELETE CASCADE
            ON UPDATE CASCADE
...
(
    ...
    `document_reservation_id`  BIGINT(20) UNSIGNED NULL DEFAULT NULL,
    ...
    UNIQUE INDEX `id_UNIQUE` (`id` ASC) VISIBLE,
    INDEX `fk_ax_catalog_order_ax_catalog_payment_type1_idx` (`catalog_payment_type_id` ASC) VISIBLE,
    INDEX `fk_ax_catalog_order_ax_catalog_delivery_type1_idx` (`catalog_delivery_type_id` ASC) VISIBLE,
    INDEX `fk_ax_catalog_order_ax_user1_idx` (`user_id` ASC) VISIBLE,
    UNIQUE INDEX `uuid_UNIQUE` (`uuid` ASC) VISIBLE,
    INDEX `fk_ax_catalog_order_ax_catalog_coupon1_idx` (`catalog_coupon_id` ASC) VISIBLE,
    INDEX `fk_ax_catalog_order_ax_document_sale1_idx` (`document_sale_id` ASC) VISIBLE,
    INDEX `fk_ax_catalog_order_ax_document_reservation1_idx` (`document_reservation_id` ASC) VISIBLE,
    ...
    CONSTRAINT `fk_ax_catalog_order_ax_document_sale1`
        FOREIGN KEY (`document_sale_id`)
            REFERENCES `a_shop`.`ax_document_sale` (`id`)
            ON DELETE CASCADE
            ON UPDATE CASCADE,
    CONSTRAINT `fk_ax_catalog_order_ax_document_reservation1`
        FOREIGN KEY (`document_reservation_id`)
            REFERENCES `a_shop`.`ax_document_reservation` (`id`)
            ON DELETE CASCADE
            ON UPDATE CASCADE
)
    ENGINE = InnoDB;
...
(
    ...
    UNIQUE INDEX `id_UNIQUE` (`id` ASC) VISIBLE,
    INDEX `fk_ax_catalog_basket_ax_user1_idx` (`user_id` ASC) VISIBLE,
    INDEX `fk_ax_catalog_basket_ax_currency1_idx` (`currency_id` ASC) VISIBLE,
    INDEX `fk_ax_catalog_basket_ax_catalog_product1_idx` (`catalog_product_id` ASC) VISIBLE,
    INDEX `fk_ax_catalog_basket_ax_catalog_order1_idx` (`catalog_order_id` ASC) VISIBLE,
...
(
    ...
    UNIQUE INDEX `id_UNIQUE` (`id` ASC) VISIBLE,
    INDEX `fk_ax_currency_exchange_rate_ax_currency1_idx` (`currency_id` ASC) VISIBLE,
...
(
    ...
    INDEX `fk_ax_catalog_product_has_ax_currency_ax_currency1_idx` (`currency_id` ASC) VISIBLE,
    INDEX `fk_ax_catalog_product_has_ax_currency_ax_catalog_product1_idx` (`catalog_product_id` ASC) VISIBLE,
...
-- -----------------------------------------------------
-- Table `a_shop`.`ax_document_coming`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `a_shop`.`ax_document_coming`;
...
(
    ...
    INDEX `fk_ax_catalog_document_ax_currency1_idx` (`currency_id` ASC) VISIBLE,
    INDEX `fk_ax_catalog_document_ax_catalog_storage_place1_idx` (`catalog_storage_place_id` ASC) VISIBLE,
    INDEX `fk_ax_document_coming_ax_fin_transaction_type1_idx` (`fin_transaction_type_id` ASC) VISIBLE,
    ...
    CONSTRAINT `fk_ax_catalog_document_ax_catalog_storage_place1`
        FOREIGN KEY (`catalog_storage_place_id`)
            ...
            ON DELETE CASCADE
            ON UPDATE CASCADE,
    CONSTRAINT `fk_ax_document_coming_ax_fin_transaction_type1`
        FOREIGN KEY (`fin_transaction_type_id`)
            REFERENCES `a_shop`.`ax_fin_transaction_type` (`id`)
            ON DELETE CASCADE
            ON UPDATE CASCADE
...
(
    ...
    INDEX `fk_ax_catalog_storage_ax_catalog_product1_idx` (`catalog_product_id` ASC) VISIBLE,
    UNIQUE INDEX `id_UNIQUE` (`id` ASC) VISIBLE,
...
-- -----------------------------------------------------
-- Table `a_shop`.`ax_document_coming_content`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `a_shop`.`ax_document_coming_content`;

CREATE TABLE IF NOT EXISTS `a_shop`.`ax_document_coming_content`
(
    `id`                 BIGINT(20) UNSIGNED NOT NULL AUTO_INCREMENT,
    `catalog_product_id` BIGINT(20) UNSIGNED NOT NULL,
    `document_coming_id` BIGINT(20) UNSIGNED NOT NULL,
    ...
    `updated_at`         INT(11) UNSIGNED    NULL DEFAULT NULL,
    `deleted_at`         INT(11) UNSIGNED    NULL DEFAULT NULL,
    PRIMARY KEY (`id`, `catalog_product_id`, `document_coming_id`),
    UNIQUE INDEX `id_UNIQUE` (`id` ASC) VISIBLE,
    INDEX `fk_ax_document_content_ax_catalog_product1_idx` (`catalog_product_id` ASC) VISIBLE,
    INDEX `fk_ax_catalog_document_content_ax_catalog_storage1_idx` (`catalog_storage_id` ASC) VISIBLE,
    INDEX `fk_ax_document_coming_content_ax_document_coming1_idx` (`document_coming_id` ASC) VISIBLE,
    ...
    CONSTRAINT `fk_ax_document_coming_content_ax_document_coming1`
        FOREIGN KEY (`document_coming_id`)
            REFERENCES `a_shop`.`ax_document_coming` (`id`)
            ON DELETE CASCADE
            ON UPDATE CASCADE
)
    ENGINE = InnoDB;
...
(
    ...
    PRIMARY KEY (`id`, `currency_id`),
    UNIQUE INDEX `id_UNIQUE` (`id` ASC) VISIBLE,
    INDEX `fk_ax_wallet_currency_ax_currency1_idx` (`currency_id` ASC) VISIBLE,
...
(
    ...
    UNIQUE INDEX `id_UNIQUE` (`id` ASC) VISIBLE,
    INDEX `fk_ax_wallet_ax_user1_idx` (`user_id` ASC) VISIBLE,
    INDEX `fk_ax_wallet_ax_wallet_currency1_idx` (`wallet_currency_id` ASC) VISIBLE,
...
(
    ...
    UNIQUE INDEX `name_UNIQUE` (`name` ASC) VISIBLE,
    INDEX `fk_ax_wallet_transaction_subject_ax_fin_transaction_type1_idx` (`fin_transaction_type_id` ASC) VISIBLE,
...
(
    ...
    UNIQUE INDEX `id_UNIQUE` (`id` ASC) VISIBLE,
    INDEX `fk_ax_wallet_transaction_ax_wallet1_idx` (`wallet_id` ASC) VISIBLE,
    INDEX `fk_ax_wallet_transaction_ax_wallet_currency1_idx` (`wallet_currency_id` ASC) VISIBLE,
    INDEX `fk_ax_wallet_transaction_ax_wallet_transaction_subject1_idx` (`wallet_transaction_subject_id` ASC) VISIBLE,
...
(
    ...
    UNIQUE INDEX `id_UNIQUE` (`id` ASC) VISIBLE,
    INDEX `fk_ax_catalog_product_widgets_ax_catalog_product1_idx` (`catalog_product_id` ASC) VISIBLE,
    INDEX `fk_ax_catalog_product_widgets_ax_render1_idx` (`render_id` ASC) VISIBLE,
...
(
    ...
    UNIQUE INDEX `id_UNIQUE` (`id` ASC) VISIBLE,
    UNIQUE INDEX `title_UNIQUE` (`title` ASC) VISIBLE,
    INDEX `fk_ax_catalog_product_widgets_content_ax_catalog_product_wi_idx` (`catalog_product_widgets_id` ASC) VISIBLE,
...
(
    ...
    INDEX `fk_ax_post_ax_render1_idx` (`render_id` ASC) VISIBLE,
    UNIQUE INDEX `url_UNIQUE` (`url` ASC) VISIBLE,
    INDEX `fk_ax_page_ax_page_type1_idx` (`page_type_id` ASC) VISIBLE,
...
(
    ...
    UNIQUE INDEX `id_UNIQUE` (`id` ASC) VISIBLE,
    PRIMARY KEY (`id`),
    INDEX `fk_ax_catalog_property_unit_ax_unit_okei1_idx` (`unit_okei_id` ASC) VISIBLE,
...
(
    ...
    UNIQUE INDEX `id_UNIQUE` (`id` ASC) VISIBLE,
    INDEX `fk_ax_catalog_product_has_value_int_ax_catalog_product1_idx` (`catalog_product_id` ASC) VISIBLE,
    INDEX `fk_ax_catalog_product_has_value_int_ax_catalog_property1_idx` (`catalog_property_id` ASC) VISIBLE,
    INDEX `fk_ax_catalog_product_has_value_int_ax_catalog_property_uni_idx` (`catalog_property_unit_id` ASC) VISIBLE,
...
(
    ...
    UNIQUE INDEX `id_UNIQUE` (`id` ASC) VISIBLE,
    INDEX `fk_ax_catalog_product_has_value_int_ax_catalog_product1_idx` (`catalog_product_id` ASC) VISIBLE,
    INDEX `fk_ax_catalog_product_has_value_varchar_ax_catalog_property_idx` (`catalog_property_id` ASC) VISIBLE,
    INDEX `fk_ax_catalog_product_has_value_varchar_ax_catalog_property_idx1` (`catalog_property_unit_id` ASC) VISIBLE,
...
(
    ...
    UNIQUE INDEX `id_UNIQUE` (`id` ASC) VISIBLE,
    INDEX `fk_ax_catalog_product_has_value_int_ax_catalog_product1_idx` (`catalog_product_id` ASC) VISIBLE,
    INDEX `fk_ax_catalog_product_has_value_text_ax_catalog_property1_idx` (`catalog_property_id` ASC) VISIBLE,
    INDEX `fk_ax_catalog_product_has_value_text_ax_catalog_property_un_idx` (`catalog_property_unit_id` ASC) VISIBLE,
...
(
    ...
    UNIQUE INDEX `id_UNIQUE` (`id` ASC) VISIBLE,
    INDEX `fk_ax_catalog_product_has_value_int_ax_catalog_product1_idx` (`catalog_product_id` ASC) VISIBLE,
    INDEX `fk_ax_catalog_product_has_value_decimal_ax_catalog_property_idx` (`catalog_property_id` ASC) VISIBLE,
    INDEX `fk_ax_catalog_product_has_value_decimal_ax_catalog_property_idx1` (`catalog_property_unit_id` ASC) VISIBLE,
...
(
    ...
    UNIQUE INDEX `id_UNIQUE` (`id` ASC) VISIBLE,
    INDEX `fk_ax_widgets_property_ax_widgets_property_type1_idx` (`widgets_property_type_id` ASC) VISIBLE,
    UNIQUE INDEX `title_UNIQUE` (`title` ASC) VISIBLE,
...
(
    ...
    UNIQUE INDEX `id_UNIQUE` (`id` ASC) VISIBLE,
    INDEX `fk_ax_catalog_product_has_value_int_copy1_ax_widgets_proper_idx` (`widgets_property_id` ASC) VISIBLE,
    INDEX `fk_ax_widgets_has_value_int_ax_widgets1_idx` (`widgets_id` ASC) VISIBLE,
...
(
    ...
    PRIMARY KEY (`id`, `widgets_id`, `widgets_property_id`),
    UNIQUE INDEX `id_UNIQUE` (`id` ASC) VISIBLE,
    INDEX `fk_ax_catalog_product_has_value_varchar_copy1_ax_widgets_pr_idx` (`widgets_property_id` ASC) VISIBLE,
    INDEX `fk_ax_widgets_has_value_varchar_ax_widgets1_idx` (`widgets_id` ASC) VISIBLE,
...
(
    ...
    PRIMARY KEY (`id`, `widgets_id`, `widgets_property_id`),
    UNIQUE INDEX `id_UNIQUE` (`id` ASC) VISIBLE,
    INDEX `fk_ax_catalog_product_has_value_text_copy1_ax_widgets_prope_idx` (`widgets_property_id` ASC) VISIBLE,
    INDEX `fk_ax_widgets_has_value_text_ax_widgets1_idx` (`widgets_id` ASC) VISIBLE,
...
(
    ...
    PRIMARY KEY (`id`, `widgets_id`, `widgets_property_id`),
    UNIQUE INDEX `id_UNIQUE` (`id` ASC) VISIBLE,
    INDEX `fk_ax_catalog_product_has_value_decimal_copy1_ax_widgets_pr_idx` (`widgets_property_id` ASC) VISIBLE,
    INDEX `fk_ax_widgets_has_value_decimal_ax_widgets1_idx` (`widgets_id` ASC) VISIBLE,
...
(
    ...
    PRIMARY KEY (`id`, `user_id`),
    UNIQUE INDEX `id_UNIQUE` (`id` ASC) VISIBLE,
    INDEX `fk_ax_user_profile_ax_catalog_delivery_type1_idx` (`catalog_delivery_type_id` ASC) VISIBLE,
    INDEX `fk_ax_user_profile_ax_catalog_payment_type1_idx` (`catalog_payment_type_id` ASC) VISIBLE,
    INDEX `fk_ax_user_profile_ax_user1_idx` (`user_id` ASC) VISIBLE,
...
(
    ...
    INDEX `fk_ax_widgets_property_has_ax_widgets_property_group_ax_wid_idx` (`widgets_property_group_id` ASC) VISIBLE,
    INDEX `fk_ax_widgets_property_has_ax_widgets_property_group_ax_wid_idx1` (`widgets_property_id` ASC) VISIBLE,
...
(
    ...
    INDEX `fk_ax_catalog_property_has_ax_catalog_property_group_ax_cat_idx` (`catalog_property_group_id` ASC) VISIBLE,
    INDEX `fk_ax_catalog_property_has_ax_catalog_property_group_ax_cat_idx1` (`catalog_property_id` ASC) VISIBLE,
...
(
    ...
    INDEX `fk_ax_catalog_property_has_ax_catalog_property_unit_ax_cata_idx` (`catalog_property_unit_id` ASC) VISIBLE,
    INDEX `fk_ax_catalog_property_has_ax_catalog_property_unit_ax_cata_idx1` (`catalog_property_id` ASC) VISIBLE,
...
(
    ...
    INDEX `fk_ax_catalog_category_has_ax_catalog_property_ax_catalog_p_idx` (`catalog_property_id` ASC) VISIBLE,
    INDEX `fk_ax_catalog_category_has_ax_catalog_property_ax_catalog_c_idx` (`catalog_category_id` ASC) VISIBLE,
...
(
    ...
    `updated_at`               INT(11) UNSIGNED    NULL DEFAULT NULL,
    `deleted_at`               INT(11) UNSIGNED    NULL DEFAULT NULL,
    PRIMARY KEY (`id`, `catalog_product_id`, `catalog_storage_place_id`, `resource`, `resource_id`),
    INDEX `fk_ax_catalog_storage_ax_catalog_product1_idx` (`catalog_product_id` ASC) VISIBLE,
    UNIQUE INDEX `id_UNIQUE` (`id` ASC) VISIBLE,
    INDEX `fk_ax_catalog_storage_reserve_ax_catalog_storage_place1_idx` (`catalog_storage_place_id` ASC) VISIBLE,
...
-- -----------------------------------------------------
-- Table `a_shop`.`ax_document_sale_content`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `a_shop`.`ax_document_sale_content`;

CREATE TABLE IF NOT EXISTS `a_shop`.`ax_document_sale_content`
(
    `id`                 BIGINT(20) UNSIGNED NOT NULL AUTO_INCREMENT,
    `catalog_product_id` BIGINT(20) UNSIGNED NOT NULL,
    `document_sale_id`   BIGINT(20) UNSIGNED NOT NULL,
    `catalog_storage_id` BIGINT(20) UNSIGNED NULL,
    `price`              DECIMAL UNSIGNED    NULL DEFAULT 0.0,
    `quantity`           INT(11) UNSIGNED    NULL DEFAULT 1,
    `description`        VARCHAR(255)        NULL,
    ...
    `updated_at`         INT(11) UNSIGNED    NULL DEFAULT NULL,
    `deleted_at`         INT(11) UNSIGNED    NULL DEFAULT NULL,
    PRIMARY KEY (`id`, `catalog_product_id`, `document_sale_id`),
    UNIQUE INDEX `id_UNIQUE` (`id` ASC) VISIBLE,
    INDEX `fk_ax_document_content_ax_catalog_product1_idx` (`catalog_product_id` ASC) VISIBLE,
    INDEX `fk_ax_catalog_document_content_ax_catalog_storage1_idx` (`catalog_storage_id` ASC) VISIBLE,
    INDEX `fk_ax_document_sale_content_ax_document_sale1_idx` (`document_sale_id` ASC) VISIBLE,
...
-- -----------------------------------------------------
-- Table `a_shop`.`ax_document_write_off`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `a_shop`.`ax_document_write_off`;
...
(
    ...
    CONSTRAINT `fk_ax_catalog_document_ax_catalog_storage_place100`
        FOREIGN KEY (`catalog_storage_place_id`)
            ...
            ON DELETE CASCADE
            ON UPDATE CASCADE,
    CONSTRAINT `fk_ax_document_sale_ax_fin_transaction_type10`
        FOREIGN KEY (`fin_transaction_type_id`)
            REFERENCES `a_shop`.`ax_fin_transaction_type` (`id`)
            ON DELETE CASCADE
            ON UPDATE CASCADE
...
-- -----------------------------------------------------
-- Table `a_shop`.`ax_document_write_off_content`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `a_shop`.`ax_document_write_off_content`;

CREATE TABLE IF NOT EXISTS `a_shop`.`ax_document_write_off_content`
(
    `id`                    BIGINT(20) UNSIGNED NOT NULL AUTO_INCREMENT,
    `catalog_product_id`    BIGINT(20) UNSIGNED NOT NULL,
    `document_write_off_id` BIGINT(20) UNSIGNED NOT NULL,
    `catalog_storage_id`    BIGINT(20) UNSIGNED NULL,
    `price`                 DECIMAL UNSIGNED    NULL DEFAULT 0.0,
    `quantity`              INT(11) UNSIGNED    NULL DEFAULT 1,
    `description`           VARCHAR(255)        NULL,
    ...
    `updated_at`            INT(11) UNSIGNED    NULL DEFAULT NULL,
    `deleted_at`            INT(11) UNSIGNED    NULL DEFAULT NULL,
    PRIMARY KEY (`id`, `catalog_product_id`, `document_write_off_id`),
    UNIQUE INDEX `id_UNIQUE` (`id` ASC) VISIBLE,
    INDEX `fk_ax_document_content_ax_catalog_product1_idx` (`catalog_product_id` ASC) VISIBLE,
    INDEX `fk_ax_catalog_document_content_ax_catalog_storage1_idx` (`catalog_storage_id` ASC) VISIBLE,
    INDEX `fk_ax_document_write_off_content_ax_document_write_off1_idx` (`document_write_off_id` ASC) VISIBLE,
    ...
    CONSTRAINT `fk_ax_document_write_off_content_ax_document_write_off1`
        FOREIGN KEY (`document_write_off_id`)
            REFERENCES `a_shop`.`ax_document_write_off` (`id`)
            ON DELETE CASCADE
            ON UPDATE CASCADE
)
    ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `a_shop`.`ax_document_reservation_content`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `a_shop`.`ax_document_reservation_content`;

CREATE TABLE IF NOT EXISTS `a_shop`.`ax_document_reservation_content`
(
    `id`                      BIGINT(20) UNSIGNED NOT NULL AUTO_INCREMENT,
    `catalog_product_id`      BIGINT(20) UNSIGNED NOT NULL,
    `document_reservation_id` BIGINT(20) UNSIGNED NOT NULL,
    `catalog_storage_id`      BIGINT(20) UNSIGNED NULL,
    `price`                   DECIMAL UNSIGNED    NULL DEFAULT 0.0,
    `quantity`                INT(11) UNSIGNED    NULL DEFAULT 1,
    `description`             VARCHAR(255)        NULL,
    ...
    `updated_at`              INT(11) UNSIGNED    NULL DEFAULT NULL,
    `deleted_at`              INT(11) UNSIGNED    NULL DEFAULT NULL,
    PRIMARY KEY (`id`, `catalog_product_id`, `document_reservation_id`),
    UNIQUE INDEX `id_UNIQUE` (`id` ASC) VISIBLE,
    INDEX `fk_ax_document_content_ax_catalog_product1_idx` (`catalog_product_id` ASC) VISIBLE,
    INDEX `fk_ax_catalog_document_content_ax_catalog_storage1_idx` (`catalog_storage_id` ASC) VISIBLE,
    INDEX `fk_ax_document_reservation_content_ax_document_reservation1_idx` (`document_reservation_id` ASC) VISIBLE,
...
-- -----------------------------------------------------
-- Table `a_shop`.`ax_document_reservation_cancel`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `a_shop`.`ax_document_reservation_cancel`;
...
(
    ...
    CONSTRAINT `fk_ax_catalog_document_ax_catalog_storage_place10000`
        FOREIGN KEY (`catalog_storage_place_id`)
            ...
            ON DELETE CASCADE
            ON UPDATE CASCADE,
    CONSTRAINT `fk_ax_document_sale_ax_fin_transaction_type1000`
        FOREIGN KEY (`fin_transaction_type_id`)
            REFERENCES `a_shop`.`ax_fin_transaction_type` (`id`)
            ON DELETE CASCADE
            ON UPDATE CASCADE
...
-- -----------------------------------------------------
-- Table `a_shop`.`ax_document_reservation_cancel_content`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `a_shop`.`ax_document_reservation_cancel_content`;

CREATE TABLE IF NOT EXISTS `a_shop`.`ax_document_reservation_cancel_content`
(
    `id`                             BIGINT(20) UNSIGNED NOT NULL AUTO_INCREMENT,
    `catalog_product_id`             BIGINT(20) UNSIGNED NOT NULL,
    `document_reservation_cancel_id` BIGINT(20) UNSIGNED NOT NULL,
    `catalog_storage_id`             BIGINT(20) UNSIGNED NULL,
    `price`                          DECIMAL UNSIGNED    NULL DEFAULT 0.0,
    `quantity`                       INT(11) UNSIGNED    NULL DEFAULT 1,
    `description`                    VARCHAR(255)        NULL,
    ...
    `updated_at`                     INT(11) UNSIGNED    NULL DEFAULT NULL,
    `deleted_at`                     INT(11) UNSIGNED    NULL DEFAULT NULL,
    PRIMARY KEY (`id`, `catalog_product_id`, `document_reservation_cancel_id`),
    UNIQUE INDEX `id_UNIQUE` (`id` ASC) VISIBLE,
    INDEX `fk_ax_document_content_ax_catalog_product1_idx` (`catalog_product_id` ASC) VISIBLE,
    INDEX `fk_ax_catalog_document_content_ax_catalog_storage1_idx` (`catalog_storage_id` ASC) VISIBLE,
    INDEX `fk_ax_document_reservation_content_copy1_ax_document_reserv_idx` (`document_reservation_cancel_id` ASC) VISIBLE,
    ...
    CONSTRAINT `fk_ax_catalog_document_content_ax_catalog_storage10000`
        FOREIGN KEY (`catalog_storage_id`)
            ...
            ON DELETE CASCADE
            ON UPDATE CASCADE,
    CONSTRAINT `fk_ax_document_reservation_content_copy1_ax_document_reservat1`
        FOREIGN KEY (`document_reservation_cancel_id`)
            REFERENCES `a_shop`.`ax_document_reservation_cancel` (`id`)
            ON DELETE CASCADE
            ON UPDATE CASCADE
)
    ENGINE = InnoDB;
