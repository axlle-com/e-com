...
-- -----------------------------------------------------
-- Table `a_shop`.`ax_comment`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `a_shop`.`ax_comment`;
...
(
    ...
    CONSTRAINT `fk_ax_post_comments_ax_post_comments1`
        FOREIGN KEY (`comment_id`)
            REFERENCES `a_shop`.`ax_comment` (`id`)
            ON DELETE CASCADE
            ON UPDATE CASCADE
)
    ENGINE = InnoDB;
...
-- Table `a_shop`.`ax_tag`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `a_shop`.`ax_tag`;
...
-- -----------------------------------------------------
-- Table `a_shop`.`ax_tag_has_resource`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `a_shop`.`ax_tag_has_resource`;
...
-- -----------------------------------------------------
-- Table `a_shop`.`ax_main_setting`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `a_shop`.`ax_main_setting`;
...
-- -----------------------------------------------------
-- Table `a_shop`.`ax_main_letter`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `a_shop`.`ax_main_letter`;
...
-- -----------------------------------------------------
-- Table `a_shop`.`ax_main_history`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `a_shop`.`ax_main_history`;
...
-- -----------------------------------------------------
-- Table `a_shop`.`ax_main_migration`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `a_shop`.`ax_main_migration`;
...
-- -----------------------------------------------------
-- Table `a_shop`.`ax_counterparty`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `a_shop`.`ax_counterparty`;
...
(
    ...
    INDEX `fk_ax_document_sale_ax_fin_transaction_type1_idx` (`fin_transaction_type_id` ASC),
...
-- -----------------------------------------------------
-- Table `a_shop`.`ax_catalog_delivery_status`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `a_shop`.`ax_catalog_delivery_status`;
...
-- -----------------------------------------------------
-- Table `a_shop`.`ax_catalog_payment_status`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `a_shop`.`ax_catalog_payment_status`;
...
-- -----------------------------------------------------
-- Table `a_shop`.`ax_document_order`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `a_shop`.`ax_document_order`;
...
(
    ...
    CONSTRAINT `fk_ax_document_order_ax_catalog_storage_place1`
        FOREIGN KEY (`catalog_storage_place_id`)
            ...
            ON DELETE CASCADE
            ON UPDATE CASCADE,
    CONSTRAINT `fk_ax_document_order_ax_fin_transaction_type1`
        FOREIGN KEY (`fin_transaction_type_id`)
            REFERENCES `a_shop`.`ax_fin_transaction_type` (`id`)
            ON DELETE CASCADE
            ON UPDATE CASCADE,
    CONSTRAINT `fk_ax_document_order_ax_catalog_delivery_status1`
        FOREIGN KEY (`catalog_delivery_status_id`)
            REFERENCES `a_shop`.`ax_catalog_delivery_status` (`id`)
            ON DELETE CASCADE
            ON UPDATE CASCADE,
...
(
    ...
    CONSTRAINT `fk_ax_catalog_basket_ax_document_order1`
        FOREIGN KEY (`document_order_id`)
            REFERENCES `a_shop`.`ax_document_order` (`id`)
            ON DELETE CASCADE
            ON UPDATE CASCADE
)
    ENGINE = InnoDB;
...
(
    ...
    INDEX `fk_ax_catalog_document_ax_currency1_idx` (`currency_id` ASC),
    INDEX `fk_ax_catalog_document_ax_catalog_storage_place1_idx` (`catalog_storage_place_id` ASC),
    INDEX `fk_ax_document_coming_ax_fin_transaction_type1_idx` (`fin_transaction_type_id` ASC),
...
-- -----------------------------------------------------
-- Table `a_shop`.`ax_catalog_property_has_category`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `a_shop`.`ax_catalog_property_has_category`;
...
-- -----------------------------------------------------
-- Table `a_shop`.`ax_document_refund`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `a_shop`.`ax_document_refund`;
...
(
    ...
    CONSTRAINT `fk_ax_catalog_document_ax_catalog_storage_place100000`
        FOREIGN KEY (`catalog_storage_place_id`)
            ...
            ON DELETE CASCADE
            ON UPDATE CASCADE,
    CONSTRAINT `fk_ax_document_sale_ax_fin_transaction_type10000`
        FOREIGN KEY (`fin_transaction_type_id`)
            REFERENCES `a_shop`.`ax_fin_transaction_type` (`id`)
            ON DELETE CASCADE
            ON UPDATE CASCADE,
...
-- -----------------------------------------------------
-- Table `a_shop`.`ax_document_refund_content`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `a_shop`.`ax_document_refund_content`;
...
(
    ...
    CONSTRAINT `fk_ax_document_refund_content_ax_document_refund1`
        FOREIGN KEY (`document_id`)
            REFERENCES `a_shop`.`ax_document_refund` (`id`)
            ON DELETE CASCADE
            ON UPDATE CASCADE
)
    ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `a_shop`.`ax_document_transfer`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `a_shop`.`ax_document_transfer`;
...
(
    ...
    CONSTRAINT `fk_ax_catalog_document_ax_catalog_storage_place1000000`
        FOREIGN KEY (`catalog_storage_place_id`)
            ...
            ON DELETE CASCADE
            ON UPDATE CASCADE,
    CONSTRAINT `fk_ax_document_sale_ax_fin_transaction_type100000`
        FOREIGN KEY (`fin_transaction_type_id`)
            REFERENCES `a_shop`.`ax_fin_transaction_type` (`id`)
            ON DELETE CASCADE
            ON UPDATE CASCADE,
...
-- -----------------------------------------------------
-- Table `a_shop`.`ax_document_transfer_content`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `a_shop`.`ax_document_transfer_content`;
...
(
    ...
    CONSTRAINT `fk_ax_document_transfer_content_ax_document_transfer1`
        FOREIGN KEY (`document_id`)
            REFERENCES `a_shop`.`ax_document_transfer` (`id`)
            ON DELETE CASCADE
            ON UPDATE CASCADE
)
    ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `a_shop`.`ax_document_invoice`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `a_shop`.`ax_document_invoice`;
...
(
    ...
    CONSTRAINT `fk_ax_catalog_document_ax_catalog_storage_place1000001`
        FOREIGN KEY (`catalog_storage_place_id`)
            ...
            ON DELETE CASCADE
            ON UPDATE CASCADE,
    CONSTRAINT `fk_ax_document_sale_ax_fin_transaction_type100001`
        FOREIGN KEY (`fin_transaction_type_id`)
            REFERENCES `a_shop`.`ax_fin_transaction_type` (`id`)
            ON DELETE CASCADE
            ON UPDATE CASCADE,
...
-- -----------------------------------------------------
-- Table `a_shop`.`ax_document_invoice_content`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `a_shop`.`ax_document_invoice_content`;
...
(
    ...
    CONSTRAINT `fk_ax_document_invoice_content_ax_document_invoice1`
        FOREIGN KEY (`document_id`)
            REFERENCES `a_shop`.`ax_document_invoice` (`id`)
            ON DELETE CASCADE
            ON UPDATE CASCADE
)
    ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `a_shop`.`ax_document_order_content`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `a_shop`.`ax_document_order_content`;
...
-- -----------------------------------------------------
-- Table `a_shop`.`ax_main_logger`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `a_shop`.`ax_main_logger`;
...
-- -----------------------------------------------------
-- Table `a_shop`.`ax_catalog_property_has_product`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `a_shop`.`ax_catalog_property_has_product`;
...
-- -----------------------------------------------------
-- Table `a_shop`.`ax_catalog_property_value_decimal`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `a_shop`.`ax_catalog_property_value_decimal`;
...
-- -----------------------------------------------------
-- Table `a_shop`.`ax_catalog_property_value_text`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `a_shop`.`ax_catalog_property_value_text`;
...
-- -----------------------------------------------------
-- Table `a_shop`.`ax_catalog_property_value_int`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `a_shop`.`ax_catalog_property_value_int`;
...
-- -----------------------------------------------------
-- Table `a_shop`.`ax_catalog_property_value_varchar`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `a_shop`.`ax_catalog_property_value_varchar`;
...
-- -----------------------------------------------------
-- Table `a_shop`.`ax_telegram_user`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `a_shop`.`ax_telegram_user`;
...
-- -----------------------------------------------------
-- Table `a_shop`.`ax_telegram_message`
-- -----------------------------------------------------
...
-- -----------------------------------------------------
-- Table `a_shop`.`ax_frm_category`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `a_shop`.`ax_frm_category`;
...
(
    ...
    CONSTRAINT `fk_ax_post_comments_ax_post_comments10`
        FOREIGN KEY (`category_id`)
            REFERENCES `a_shop`.`ax_frm_category` (`id`)
            ON DELETE CASCADE
            ON UPDATE CASCADE,
...
-- -----------------------------------------------------
-- Table `a_shop`.`ax_frm_message`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `a_shop`.`ax_frm_message`;
...
(
    ...
    CONSTRAINT `fk_ax_post_comments_ax_post_comments100`
        FOREIGN KEY (`message_id`)
            REFERENCES `a_shop`.`ax_frm_message` (`id`)
            ON DELETE CASCADE
            ON UPDATE CASCADE,
...
-- -----------------------------------------------------
-- Table `a_shop`.`ax_main_url`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `a_shop`.`ax_main_url`;
...
VALUES (6, 'Алексей', 'Алексеев', 'Александрович', '9621829550', 'axlle@mail.ru', 0, 1, 8, NULL,
        '$2y$13$DMqEjJJL9gjftb80gCt5n.fOTyoTfAEv/HsQPh2IEQa42bfNsfF5S', 'kyyBBbb80b3ZfldsynKC0B4skxf',
        'kyyBBbb80b3ZflMDdsynKC0B4skxf_gF', 'kyyBBbb80b3ZflMDdsynKC0B4s', UNIX_TIMESTAMP(), NULL, NULL);
