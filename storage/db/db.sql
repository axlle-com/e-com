...
(
    `id`                        BIGINT(20) UNSIGNED NOT NULL AUTO_INCREMENT,
    `catalog_property_group_id` BIGINT(20) UNSIGNED NULL,
    `title`                     VARCHAR(255)        NOT NULL,
    `description`               VARCHAR(255)        NULL,
    `sort`                      INT(11)             NULL,
    `image`                     VARCHAR(255)        NULL DEFAULT NULL,
    ...
    UNIQUE INDEX `id_UNIQUE` (`id` ASC),
    PRIMARY KEY (`id`),
    INDEX `fk_ax_catalog_property_ax_catalog_property_group1_idx` (`catalog_property_group_id` ASC),
    CONSTRAINT `fk_ax_catalog_property_ax_catalog_property_group1`
...
(
    ...
    INDEX `fk_ax_catalog_basket_ax_catalog_document1_idx` (`catalog_document_id` ASC),
    ...
    CONSTRAINT `fk_ax_catalog_basket_ax_currency1`
        FOREIGN KEY (`currency_id`)
            ...
            ON DELETE CASCADE
            ON UPDATE CASCADE,
    CONSTRAINT `fk_ax_catalog_basket_ax_catalog_document1`
...
(
    `id`                   BIGINT(20) UNSIGNED NOT NULL AUTO_INCREMENT,
    `catalog_property_id`  BIGINT(20) UNSIGNED NULL,
    ...
    UNIQUE INDEX `id_UNIQUE` (`id` ASC),
    PRIMARY KEY (`id`),
    INDEX `fk_ax_catalog_property_unit_ax_catalog_property1_idx` (`catalog_property_id` ASC),
    INDEX `fk_ax_catalog_property_unit_ax_unit_okei1_idx` (`unit_okei_id` ASC),
    CONSTRAINT `fk_ax_catalog_property_unit_ax_catalog_property1`
...
(
    `id`                        BIGINT(20) UNSIGNED NOT NULL AUTO_INCREMENT,
    `widgets_property_group_id` BIGINT(20) UNSIGNED NULL,
    `title`                     VARCHAR(255)        NOT NULL,
    `description`               VARCHAR(255)        NULL,
    `sort`                      INT(11)             NULL,
    `image`                     VARCHAR(255)        NULL DEFAULT NULL,
    ...
    PRIMARY KEY (`id`),
    UNIQUE INDEX `id_UNIQUE` (`id` ASC),
    INDEX `fk_ax_widgets_property_ax_widgets_property_group1_idx` (`widgets_property_group_id` ASC),
    CONSTRAINT `fk_ax_widgets_property_ax_widgets_property_group1`
...
-- -----------------------------------------------------
-- Table `a_shop`.`ax_address_type`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `a_shop`.`ax_address_type`;

CREATE TABLE IF NOT EXISTS `a_shop`.`ax_address_type`
(
    `id`          BIGINT(20) UNSIGNED NOT NULL AUTO_INCREMENT,
    `alias`       VARCHAR(255)        NOT NULL,
    `title`       VARCHAR(255)        NOT NULL,
...
(
    ...
    `resource`        VARCHAR(255)        NOT NULL,
    `resource_id`     BIGINT(20) UNSIGNED NOT NULL,
    `is_delivery`     TINYINT(1) UNSIGNED NOT NULL DEFAULT 0,
    ...
    `updated_at`      INT(11) UNSIGNED    NULL     DEFAULT NULL,
    `deleted_at`      INT(11) UNSIGNED    NULL     DEFAULT NULL,
    PRIMARY KEY (`id`, `address_type_id`, `resource`, `resource_id`),
    UNIQUE INDEX `id_UNIQUE` (`id` ASC),
    INDEX `fk_ax_address_ax_address_type1_idx` (`address_type_id` ASC),
    CONSTRAINT `fk_ax_address_ax_address_type1`
        FOREIGN KEY (`address_type_id`)
            REFERENCES `a_shop`.`ax_address_type` (`id`)
            ON DELETE CASCADE
            ON UPDATE CASCADE
)
    ENGINE = InnoDB;
...
START TRANSACTION;
USE `a_shop`;
INSERT INTO `a_shop`.`ax_user` (`id`, `first_name`, `last_name`, `patronymic`, `phone`, `email`, `password_hash`,
                                `status`, `remember_token`, `auth_key`, `password_reset_token`, `verification_token`,
                                `created_at`, `updated_at`, `deleted_at`)
VALUES (6, 'Алексей', 'Алексеев', 'Александрович', '79621829550', 'axlle@mail.ru',
