...
(
    ...
    INDEX `fk_ax_catalog_document_ax_catalog_storage_place1_idx` (`catalog_storage_place_id` ASC),
    INDEX `fk_ax_document_sale_ax_fin_transaction_type1_idx` (`fin_transaction_type_id` ASC),
    INDEX `fk_ax_document_write_off_ax_counterparty1_idx` (`counterparty_id` ASC),
    ...
    CONSTRAINT `fk_ax_document_sale_ax_fin_transaction_type10`
        FOREIGN KEY (`fin_transaction_type_id`)
            ...
            ON DELETE CASCADE
            ON UPDATE CASCADE,
    CONSTRAINT `fk_ax_document_write_off_ax_counterparty1`
        FOREIGN KEY (`counterparty_id`)
            REFERENCES `a_shop`.`ax_counterparty` (`id`)
            ON DELETE CASCADE
            ON UPDATE CASCADE
...
(
    ...
    CONSTRAINT `fk_ax_document_sale_ax_fin_transaction_type1000`
        FOREIGN KEY (`fin_transaction_type_id`)
            ...
            ON DELETE CASCADE
            ON UPDATE CASCADE,
    CONSTRAINT `fk_ax_document_reservation_cancel_ax_counterparty1`
        FOREIGN KEY (`counterparty_id`)
            REFERENCES `a_shop`.`ax_counterparty` (`id`)
            ON DELETE CASCADE
            ON UPDATE CASCADE
...
(
    `id`                 BIGINT(20) UNSIGNED NOT NULL AUTO_INCREMENT,
    `documentl_id`       BIGINT(20) UNSIGNED NOT NULL,
    `catalog_product_id` BIGINT(20) UNSIGNED NOT NULL,
    `catalog_storage_id` BIGINT(20) UNSIGNED NULL,
    `price`              DECIMAL UNSIGNED    NULL DEFAULT 0.0,
    `quantity`           INT(11) UNSIGNED    NULL DEFAULT 1,
    ...
    `updated_at`         INT(11) UNSIGNED    NULL DEFAULT NULL,
    `deleted_at`         INT(11) UNSIGNED    NULL DEFAULT NULL,
    PRIMARY KEY (`id`, `documentl_id`, `catalog_product_id`),
    UNIQUE INDEX `id_UNIQUE` (`id` ASC),
    INDEX `fk_ax_document_content_ax_catalog_product1_idx` (`catalog_product_id` ASC),
    INDEX `fk_ax_catalog_document_content_ax_catalog_storage1_idx` (`catalog_storage_id` ASC),
    INDEX `fk_ax_document_reservation_cancel_content_ax_document_reser_idx` (`documentl_id` ASC),
