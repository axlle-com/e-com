...
(
    ...
    INDEX `fk_ax_catalog_property_value_ax_catalog_property_unit1_idx` (`catalog_property_unit_id` ASC),
    CONSTRAINT `fk_ax_catalog_property_value_ax_catalog_property1`
        FOREIGN KEY (`property_id`)
            REFERENCES `a_shop`.`ax_catalog_property` (`id`)
            ON DELETE CASCADE
            ON UPDATE CASCADE,
    CONSTRAINT `fk_ax_catalog_property_value_ax_catalog_property_unit1`
