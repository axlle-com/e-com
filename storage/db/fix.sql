...
(
    ...
    `catalog_document_content_id` BIGINT(20) UNSIGNED NULL,
    ...
    INDEX `fk_ax_catalog_document_content_ax_catalog_document_content1_idx` (`catalog_document_content_id` ASC),
    ...
    CONSTRAINT `fk_ax_catalog_document_content_ax_catalog_storage1`
        FOREIGN KEY (`catalog_storage_id`)
            ...
            ON DELETE CASCADE
            ON UPDATE CASCADE,
    CONSTRAINT `fk_ax_catalog_document_content_ax_catalog_document_content1`
        FOREIGN KEY (`catalog_document_content_id`)
            REFERENCES `a_shop`.`ax_catalog_document_content` (`id`)
            ON DELETE CASCADE
            ON UPDATE CASCADE
)
    ENGINE = InnoDB;
