...
INSERT INTO `ax_catalog_document` (`id`, `user_id`, `catalog_document_subject_id`, `currency_id`, `ips_id`,
                                   ...
                                   `updated_at`, `deleted_at`)
VALUES (1, 6, 3, NULL, 2, NULL, NULL, 1, 1652175839, 1652175839, NULL),
       (2, 6, 3, NULL, 2, NULL, NULL, 1, 1652175839, 1652175839, NULL),
       (3, 6, 3, NULL, 2, NULL, NULL, 1, 1652175839, 1652175839, NULL),
       (4, 6, 3, NULL, 2, NULL, NULL, 1, 1652175839, 1652175839, NULL),
       (5, 6, 3, NULL, 2, NULL, NULL, 1, 1652175839, 1652175839, NULL),
       (6, 6, 3, NULL, 2, NULL, NULL, 1, 1652175839, 1652175839, NULL),
       (7, 6, 3, NULL, 2, NULL, NULL, 1, 1652175839, 1652175839, NULL),
       (8, 6, 3, NULL, 2, NULL, NULL, 1, 1652175839, 1652175839, NULL),
       (9, 6, 3, NULL, 2, NULL, NULL, 1, 1652175839, 1652175839, NULL),
       (10, 6, 3, NULL, 2, NULL, NULL, 1, 1652175839, 1652175839, NULL),
       (11, 6, 3, NULL, 2, NULL, NULL, 1, 1652175839, 1652175839, NULL);
...
INSERT INTO `ax_catalog_document_content` (`id`, `catalog_document_id`, `catalog_product_id`, `catalog_storage_id`,
                                           `price`, `quantity`, `description`, `created_at`, `updated_at`, `deleted_at`)
VALUES (1, 1, 2, 1, 2000, 1, NULL, 1652175839, 1652175839, NULL),
       (2, 2, 3, 2, 1100, 1, NULL, 1652175839, 1652175839, NULL),
       (3, 3, 4, 3, 1800, 1, NULL, 1652175839, 1652175839, NULL),
       (4, 4, 5, 4, 2000, 1, NULL, 1652175839, 1652175839, NULL),
       (5, 5, 6, 5, 2000, 1, NULL, 1652175839, 1652175839, NULL),
       (6, 6, 7, 6, 2200, 1, NULL, 1652175839, 1652175839, NULL),
       (7, 7, 8, 7, 2500, 1, NULL, 1652175839, 1652175839, NULL),
       (8, 8, 9, 8, 2800, 1, NULL, 1652175839, 1652175839, NULL),
       (9, 9, 10, 9, 2300, 1, NULL, 1652175839, 1652175839, NULL),
       (10, 10, 11, 10, 1500, 1, NULL, 1652175839, 1652175839, NULL),
       (11, 11, 12, 11, 1600, 1, NULL, 1652175839, 1652175839, NULL);
...
VALUES (2, 3, NULL, 1, 0, 0, 0, NULL, 'zakat', 'zakat', '✶ Закат ✶', 2000.00, NULL, NULL,
       ...
       (8, 3, NULL, 1, 0, 0, 0, NULL, 'vorobushek', 'vorobushek', '✶ Воробушек ✶', 2500.00, NULL, NULL,
        ...
        0.00, 1651861503, 1652289593, NULL),
       (9, 2, NULL, 1, 0, 0, 0, NULL, 'forel', 'forel', '✶ Форель ✶', 2800.00, NULL, NULL,
        ...
        1651861443, 1652289593, NULL),
       (10, 2, NULL, 1, 0, 0, 0, NULL, 'shtopor', 'shtopor', '✶ Штопор ✶', 2300.00, NULL, NULL,
        '<p>Идеальный намёк на чудный вечер.</p>', NULL, NULL, 1,
        '/upload/ax_catalog_product/shtopor/3kjaLFGThRo7azz2oSutNqUlatUnvlr2elROpTUa.jpeg', 0, 11, 0.00, 1651861383,
        1652289593, NULL),
       (11, 2, NULL, 1, 0, 0, 0, NULL, 'paporotnik', 'paporotnik', '✶ Папоротник ✶', 1500.00, NULL, NULL,
        'Готовим вкусно, подаём красиво.', NULL, NULL, 1,
        '/upload/ax_catalog_product/paporotnik/DJiOIvhybxRTee79lp5j914jUfb2ai4dMCXNFXAy.jpeg', 0, 2, 0.00, 1651861263,
        1652289593, NULL),
       (12, 3, NULL, 1, 0, 0, 0, NULL, 'glaz-zebry', 'glaz-zebry', '✶ Глаз зебры ✶', 1600.00, NULL, NULL,
        ...
        0.00, 1651861323, 1652289593, NULL);
...
VALUES (1, 1, 2, 1, 0, NULL, 1652175839, 1652175839, NULL),
       (2, 1, 3, 1, 0, NULL, 1652175839, 1652175839, NULL),
       (3, 1, 4, 1, 0, NULL, 1652175839, 1652175839, NULL),
       (4, 1, 5, 1, 0, NULL, 1652175839, 1652175839, NULL),
       (5, 1, 6, 1, 0, NULL, 1652175839, 1652175839, NULL),
       (6, 1, 7, 1, 0, NULL, 1652175839, 1652175839, NULL),
       (7, 1, 8, 1, 0, NULL, 1652175839, 1652175839, NULL),
       (8, 1, 9, 1, 0, NULL, 1652175839, 1652175839, NULL),
       (9, 1, 10, 1, 0, NULL, 1652175839, 1652175839, NULL),
       (10, 1, 11, 1, 0, NULL, 1652175839, 1652175839, NULL),
       (11, 1, 12, 1, 0, NULL, 1652175839, 1652175839, NULL);
...
VALUES (1, '2022_01_01_075639_first_dump', 1),
       ...
       (7, '2022_05_09_193948_create_fix_address_coupon_document_storage', 3);
