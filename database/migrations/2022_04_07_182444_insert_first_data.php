...
return new class extends Migration {
    ...
    private function setPortfolio(): void
    {
        ...
        $model = [
            ...
            'user_id' => 6,
            'images' => [
                ['file' => public_path('/frontend/assets/img/pm1.jpg')],
                ['file' => public_path('/frontend/assets/img/pm2.jpg')],
                ['file' => public_path('/frontend/assets/img/pm3.jpg')],
                ['file' => public_path('/frontend/assets/img/pm4.jpg')],
                ['file' => public_path('/frontend/assets/img/pm5.jpg')],
                ['file' => public_path('/frontend/assets/img/pm6.jpg')],
                ['file' => public_path('/frontend/assets/img/pm7.jpg')],
                ['file' => public_path('/frontend/assets/img/pm8.jpg')],
                ['file' => public_path('/frontend/assets/img/pm9.jpg')],
                ['file' => public_path('/frontend/assets/img/pm10.jpg')],
                ['file' => public_path('/frontend/assets/img/pm11.jpg')],
                ['file' => public_path('/frontend/assets/img/pm12.jpg')],
                ['file' => public_path('/frontend/assets/img/pm13.jpg')],
                ['file' => public_path('/frontend/assets/img/pm14.jpg')],
                ['file' => public_path('/frontend/assets/img/pm15.jpg')],
            ]
        ];
        $page = Page::createOrUpdate($model);
        if ($page->getErrors()) {
