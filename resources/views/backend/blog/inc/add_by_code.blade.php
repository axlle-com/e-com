                    ...
                    <div class="col-sm-6">
                            ...
                            <?php foreach ($galleries as $gallery){ ?>
                                <div class="parts-gallery">
                                    <div class="custom-control custom-radio">
                                        <input
                                            type="radio"
                                            id="customRadio-<?= $uuid ?>-<?= $gallery->id ?>"
                                            name="document_credit[item][<?= $uuid ?>][catalog_gallery_id]"
                                            value="<?= $gallery->id ?>"
                                            class="custom-control-input"
                                            <?= $model->catalog_gallery_id == $gallery->id ? 'checked' : '' ?>
                                        >
                                        <label class="custom-control-label" for="customRadio-<?= $uuid ?>-<?= $gallery->id ?>"></label>
                        ...
                        <div class="parts-gallery">
                            <div class="custom-control custom-radio">
                                ...
                                >
                                <label class="custom-control-label" for="customRadio-<?= $uuid ?>">
                                    Новая галерея
                                </label>
                            </div>
                        </div>
