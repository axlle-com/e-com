...
use App\Common\Models\Catalog\Category\CatalogCategory;use App\Common\Models\Catalog\Product\CatalogProduct;use App\Common\Models\Render;

?>
<div class="table-responsive">
    <form id="product-form-filter"></form>
    <table
        ...
        <tr class="column-filter">
            <th colspan="2">
                <button
                    type="button"
                    class="btn btn-sm btn-outline-primary btn-block has-icon js-product-down">
            ...
            <td>
                <div class="custom-control custom-control-nolabel custom-checkbox">
                    <input
                        ...
                        id="checkbox-<?= $item->id ?>"
                        data-js-product-id-checkbox="<?= $item->id ?>">
