                                ...
                                <div class="row">
                                    <div class="col-sm-4">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-12">
                                                <?php if(count($pid = CatalogPropertyType::forSelect())){ ?>
                                                <div class="form-group small">
                                                    <?php if($model->catalog_property_type_id){ ?>
                                                    ...
                                                    <?= $model->catalog_property_type_id ? 'disabled' : '' ?>>
                                                        ...
                                                        <option
                                                                value="<?= $item['id'] ?>" <?= ($item['id'] == $model->catalog_property_type_id) ? 'selected' : ''?>><?= $item['title'] ?></option>
                                                        <?php } ?>
                                                    </select>
                                                    <div class="invalid-feedback"></div>
                                                </div>
                                            ...
                                            <div class="col-sm-12">
                                                <?php if(count($pid = CatalogPropertyUnit::forSelect())){ ?>
                                                <div class="form-group small">
                                                    ...
                                                    <select
                                                        ...
                                                        <?php foreach ($pid as $item){ ?>
                                                        <option
                                                                value="<?= $item['id'] ?>" <?= ($item['id'] == $model->catalog_property_unit_id) ? 'selected' : ''?>><?= $item['title'] ?></option>
                                                        <?php } ?>
                                                    </select>
                                                    <div class="invalid-feedback"></div>
                                                </div>
