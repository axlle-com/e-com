                ...
                <div class="input-group">
                    ...
                    <div class="form-group prop small">
                        <select
                            ...
                            data-validator="property_id" <?= $property_value_id ? 'disabled' : '' ?>>
                            <option></option>
                            ...
                            <option
                                ...
                                value="<?= $property->id ?>" <?= ($property->id == ($propertyModel->property_id ?? null)) ? 'selected' : ''?>>
                                <?= $property->title ?>
                            </option>
                            <?php } ?>
                        </select>
                    ...
                    <div class="form-group units small">
                        <select
                            ...
                            data-validator="property_unit_id" <?= $property_value_id ? 'disabled' : '' ?>>
                            <option></option>
                            <?php foreach ($units as $unit){ ?>
                            <option
                                value="<?= $unit->id ?>" <?= ($unit->id == ($propertyModel->property_unit_id ?? null)) ? 'selected' : ''?>>
                                <?= $unit->title ?>
                            </option>
                            <?php } ?>
                        </select>
                    ...
                    <div class="form-group sort small">
                        <input
                            type="number"
                            value="<?= $propertyModel->property_value_sort ?? null ?>"
                    ...
                    <div class="form-group value small">
                        <input
                            type="hidden"
                            value="<?= $propertyModel->property_value_id ?? null ?>"
