...
$array2 = [
    [
        'title' => 'Виталий (Генеральный директор, ООО ХОРЕКА)',
    ...
    [
        'title' => 'Екатерина Висторова (Менеджер, МОБО «Национальный центр социальной помощи»)',
    ...
    [
        'title' => 'Дмитрий Кацуба (Генеральный директор, Free Brand LLC)',
